...
const BELT_DEFS: BeltDef[] = [
  { name: 'top', texturePath: 'textures/block/belt_scroll.png', textureId: 'create:block/belt', uvOverride: [0, 0, 1, 0.5], scrollMult: 0.5 },
  { name: 'diagonal', texturePath: 'textures/block/belt_diagonal_scroll.png', textureId: 'create:block/belt_diagonal', uvOverride: [0, 0, 1, 0.5], scrollMult: 3 / 8 },
